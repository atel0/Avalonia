...
{
    public class BindingExpressionTests_TwoWay
    {
        [Fact]
        public void Should_Set_Simple_Property_Value()
        {
            var data = new Class1 { Foo = "123" };
            var target = BindingExpression.TwoWay(data, o => o.Foo, (o, v) => o.Foo = v);
        ...
        public void Should_Set_Nested_Property_Value()
        {
            ...
            var target = BindingExpression.TwoWay(data, o => o.Next.Bar, (o, v) => o.Next.Bar = v);
        ...
        public void Pushing_Null_To_RootObservable_Updates_Correct_Object()
        {
            ...
            var target = BindingExpression.TwoWay(rootObservable, o => o.Next.Bar, (o, v) => o.Next.Bar = v);
